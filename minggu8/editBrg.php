...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="list-product.php" class="logo d-flex align-items-center">
        ...
        <span class="d-none d-lg-block">TokoABC</span>
      </a>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      ...
      <h5>kembali ke <a href='manage.php'><span class="badge bg-secondary">Manajemen Barang</span></a></h5>
    </div><!-- End Page Title -->
          ...
          <div class="card">
            <div class="card-body">
			  ...
			  <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type='text' name='tid' class="form-control" value="<?= $id;?>" readonly>
                  </div>
                </div>
                <div class="row mb-3">
                  <label for="inputText" class="col-sm-2 col-form-label">Nama Barang</label>
                  <div class="col-sm-10">
                    <input type='text' name='tnama' value="<?= $nama;?>" class="form-control">
                  </div>
                </div>
                <div class="row mb-3">
                  <label for="inputEmail" class="col-sm-2 col-form-label">Harga</label>
                  <div class="col-sm-10">
                    <input type='text' name='thrg' value="<?= $hrg;?>" class="form-control">
                  </div>
				  </div>  
				<div class="row mb-3">
                  <label for="inputNumber" class="col-sm-2 col-form-label">Jumlah</label>
                  <div class="col-sm-10">
                    <input type='text' name='tjml' value="<?= $jml;?>" class="form-control">
                  </div>
                </div>
                <div class="row mb-3">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
					...
					<img src="img/<?php echo $foto; ?>" width="150px" height="120px" /></br>
					<input type="checkbox" name="ubah_foto" value="true"> Ceklis jika ingin mengubah foto<br>
					<p>Hanya gambar dengan ektensi JPG/PNG/GIF ukuran maksimal 1GB yang diijinkan</p>
                  </div>
                <div class="row mb-3">
                  <div class="col-sm-10">
