		...
		<div class="row">
			...
			<div class="row">
				...
				if (!empty($_SESSION['keranjang'])){
					...
					<h5><a href='list-product.php'><span class='badge bg-primary'>Lanjut belanja</span></a>
					<a href=cart-remove.php><span class='badge bg-danger'>Kosongkan Cart</span></a></h5><br/><br/>
				<?php
				}else
					echo "<h5>Keranjang Kosong<br><br>Kembali ke <a href='list-product.php'><span class='badge bg-primary'>Daftar Product</span></a></h5>";
				?>			
