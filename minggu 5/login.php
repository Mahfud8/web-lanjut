...
if(isset($_POST['login'])){
    ...
    $sql = "SELECT * FROM user WHERE username=nama OR email=email";
    $stmt = $db->prepare($sql);
...
if (isset ($_POST['Login'])) {
    ...
    if ($user == "Mahfud" && $pass = "123456") {
        ...
        Klik <a href = 'login.php'> disini </a> untuk LOGIN kembali </h2>";
    } */
} else {
    ?>
    <!doctype html>
    ...
    <form action="" method="post">
        ...
        <button class="w-100 btn btn-lg btn-primary" type="submit" name="Login" value="Log In">Sign in</button>
